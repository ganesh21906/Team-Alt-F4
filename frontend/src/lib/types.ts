...
export interface ModelDiagnostics {
  accuracy_benchmarks: {
    school: { accuracy: number; precision: number; recall: number; f1: number };
    college: { accuracy: number; precision: number; recall: number; f1: number };
  };
  global_shap: {
    school: { feature: string; importance: number; category: string; description: string }[];
    college: { feature: string; importance: number; category: string; description: string }[];
  };
}
